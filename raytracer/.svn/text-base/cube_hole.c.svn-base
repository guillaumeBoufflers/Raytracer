/*
** cube_hole.c for rt in /home/dell-a_f/rt/raytracer
** 
** Made by florian dell'aiera
** Login   <dell-a_f@epitech.net>
** 
** Started on  Fri Jun  1 12:56:26 2012 florian dell'aiera
** Last update Sun Jun  3 12:43:14 2012 guillaume boell
*/
...
int		cube_hole(t_cod *cor, t_tmp *tmp, t_obj *obc, t_sph *obj_a)
{
  double	d0;
  double	d1;
  double	d2;
